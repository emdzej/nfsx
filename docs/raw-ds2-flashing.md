...
14. **`.0PA` regions describe BMW's update slices via the DS2 path,
    ...
    region tables baked into the host code. Through bootmode
    the entire 512 KB *is* writable — see `bootmode.md`.

15. **Bootmode flashing is a different protocol entirely.**
    ...
    table. See `bootmode.md` for full documentation.
